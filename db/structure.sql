...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@mail\.dk$'::text))
);
...
--
-- Name: index_products_on_authors; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_products_on_authors ON products USING btree (authors);
...
CREATE UNIQUE INDEX index_products_on_title ON products USING btree (title);
